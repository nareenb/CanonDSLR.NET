...
namespace com.aperis.CanonDSLR.CanonSDK
{
    ...
    public enum ObjectEvent : uint
    {
        ...
        /// <summary>
        /// Notifies of the creation of objects such as new folders or files on
        /// a camera compact flash card or the like. 
        /// This event is generated if the camera has been set to store captured
        /// images simultaneously on the camera and a computer, for example, but
        /// not if the camera is set to store images on the computer alone. 
        /// Newly created objects are indicated by event data.
        /// Because objects are not indicated for type 1 protocol standard cameras,
        /// (that is, objects are indicated as NULL), you must again retrieve child
        /// objects under the camera object to identify the new objects.
        /// </summary>
        ...
        /// Furthermore, if the application does not require the objects, instead of downloading them,
        ...
        /// downloading them, execute EdsDownloadCancel and release resources held by the camera.
        /// Notification of this event is not issued for type 1 protocol standard cameras.
        /// </summary>
        DirItemRequestTransferDT    = 0x00000209,

        /// <summary>
        /// Notifies of requests from a camera to cancel object transfer if the button to
        /// cancel direct transfer is pressed on the camera.
        /// If the parameter is 0, it means that cancellation of transfer is requested for
        /// objects still not downloaded, with these objects indicated by
        /// kEdsDirItemRequestTransferDT.
        /// Notification of this event is not issued for type 1 protocol standard cameras.
        /// </summary>
